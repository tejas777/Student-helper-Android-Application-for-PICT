...
public class Classessentc extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        {
            case R.id.tvse:
                startActivity(new Intent(this,TimetablesS3.class));
                break;
            case R.id.tvte:
                startActivity(new Intent(this,Timetable3.class));
                break;
            case R.id.tvbe:
                startActivity(new Intent(this,TimetableB3.class));
                break;
        }
    }
}
