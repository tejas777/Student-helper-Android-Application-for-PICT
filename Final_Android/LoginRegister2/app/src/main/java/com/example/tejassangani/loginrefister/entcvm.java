...
public class entcvm extends AppCompatActivity {
    ...
    class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titlesv=res.getStringArray(R.array.visionentc);
            String[] descriptionsv=res.getStringArray(R.array.descriptionvisionentc);
            for (int i=0;i<2;i++) {
