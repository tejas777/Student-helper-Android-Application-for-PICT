...
public class TocRefrences extends AppCompatActivity {
    ...
    class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titles=res.getStringArray(R.array.titlesreftoc);
            String[] descriptions=res.getStringArray(R.array.descriptionreftoc);
            for (int i=0;i<6;i++)
            {
