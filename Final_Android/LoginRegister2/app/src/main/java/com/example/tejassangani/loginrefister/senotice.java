...
public class senotice extends AppCompatActivity {
    ...
    class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titles=res.getStringArray(R.array.senotice);
            String[] descriptions=res.getStringArray(R.array.sedescription);
            for (int i=0;i<6;i++)
            {
