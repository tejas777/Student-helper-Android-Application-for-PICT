...
public class collegevm extends AppCompatActivity {
    ...
    class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titlesv=res.getStringArray(R.array.vision);
            String[] descriptionsv=res.getStringArray(R.array.descriptionvision);
            for (int i=0;i<2;i++) {
