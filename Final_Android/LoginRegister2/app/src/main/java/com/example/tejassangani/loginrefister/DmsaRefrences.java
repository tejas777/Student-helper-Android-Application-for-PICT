...
public class DmsaRefrences extends AppCompatActivity {
    ...
    class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titles=res.getStringArray(R.array.titlesrefdmsa);
            String[] descriptions=res.getStringArray(R.array.descriptionrefdmsa);
            for (int i=0;i<6;i++)
            {
