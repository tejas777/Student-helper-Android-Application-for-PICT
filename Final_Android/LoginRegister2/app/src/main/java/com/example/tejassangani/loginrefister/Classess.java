...
public class Classess extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        {
            case R.id.tvse:
                startActivity(new Intent(this,TimetablesS1.class));
                break;
            case R.id.tvte:
                startActivity(new Intent(this,Timetable1.class));
                break;
            case R.id.tvbe:
                startActivity(new Intent(this,TimetableB1.class));
                break;
        }
    }
}
