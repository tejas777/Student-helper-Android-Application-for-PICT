...
public class CfcaRefrences extends AppCompatActivity {
    ...
    class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titles=res.getStringArray(R.array.titlesrefcfca);
            String[] descriptions=res.getStringArray(R.array.descriptionrefcfca);
            for (int i=0;i<6;i++)
            {
