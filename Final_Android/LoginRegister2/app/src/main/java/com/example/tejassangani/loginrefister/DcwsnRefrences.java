...
public class DcwsnRefrences extends AppCompatActivity {
    ...
    class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titles=res.getStringArray(R.array.titlesrefdcwsn);
            String[] descriptions=res.getStringArray(R.array.descriptionrefdcwsn);
            for (int i=0;i<6;i++)
            {
