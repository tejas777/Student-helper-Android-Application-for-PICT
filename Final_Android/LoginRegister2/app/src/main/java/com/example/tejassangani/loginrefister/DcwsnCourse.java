...
public class DcwsnCourse extends AppCompatActivity {
    ...
    class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titles=res.getStringArray(R.array.titles4);
            String[] descriptions=res.getStringArray(R.array.description4);
            for (int i=0;i<6;i++)
            {
