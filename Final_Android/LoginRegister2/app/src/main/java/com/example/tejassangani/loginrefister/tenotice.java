...
public class tenotice extends AppCompatActivity {
    ...
    class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titles=res.getStringArray(R.array.tenotice);
            String[] descriptions=res.getStringArray(R.array.tedescription);
            for (int i=0;i<6;i++)
            {
