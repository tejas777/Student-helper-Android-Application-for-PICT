...
public class CfcaCourse2 extends AppCompatActivity {
    ...
    class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titles=res.getStringArray(R.array.titles3);
            String[] descriptions=res.getStringArray(R.array.description3);
            for (int i=0;i<6;i++)
            {
