...
public class Noticesit extends AppCompatActivity {

    ListView list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_noticesit);

        list=(ListView)findViewById(R.id.noticesit);
    ...
    class noticeadapter extends BaseAdapter {
        ...
        noticeadapter(Context c){
            ...
            String[] descriptions=res.getStringArray(R.array.descriptionit);
            for (int i=0;i<6;i++)
            {
