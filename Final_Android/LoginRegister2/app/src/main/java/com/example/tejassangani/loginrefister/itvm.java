...
public class itvm extends AppCompatActivity {
    ...
    class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titlesv=res.getStringArray(R.array.visionit);
            String[] descriptionsv=res.getStringArray(R.array.descriptionvisionit);
            for (int i=0;i<2;i++) {
