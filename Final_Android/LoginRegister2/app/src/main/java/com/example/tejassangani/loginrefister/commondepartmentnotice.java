...
public class commondepartmentnotice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url= "http://192.168.43.248/app/notices.php";
    ...
    /*class tocadapter extends BaseAdapter {
        ...
        tocadapter(Context c){
            ...
            String[] titles=res.getStringArray(R.array.commonnotice);
            String[] descriptions=res.getStringArray(R.array.commondescription);
            for (int i=0;i<6;i++)
            {
